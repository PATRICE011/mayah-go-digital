...
class UpdateProfileController extends Controller
{
    ...
    public function sendCode(Request $request)
    {
        ...
        $response = Http::withOptions(['verify' => false])
            ->post('https://api.semaphore.co/api/v4/priority', [
                ...
                'number' => $user->mobile,
                'message' => "Your OTP is $otp. This code is valid for 1 minute.",
    ...
    public function updateProfile(Request $request)
    {
        ...
        // Validate OTP (adjust expiration time to 1 minute for testing)
        $otpExpired = Carbon::parse($user->otp_created_at)->diffInMinutes(Carbon::now()) > 1;
