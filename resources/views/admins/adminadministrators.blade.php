        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h3 class="mb-2">Administrators</h3>
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="#" class="breadcrumb-link">Administrators</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="filterModalLabel">Filter Administrators</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="filterForm">
                                            <div class="form-group">
                                                <label for="filteAdminName">Administrator Name</label>
                                                <input type="text" class="form-control" id="filterName" placeholder="Enter administrator name">
                                            </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="addForm">
                                            <div class="form-group">
                                                <label for="addName">Administrator Name</label>
                                                <input type="text" class="form-control" id="addAdminName" placeholder="Enter Administrator name">
                                            </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-primary" onclick="applyFilters()">Add Administrator</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="action__btn">
                                                ...
                                                <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="editModalLabel">Edit Administrator Info</h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="editForm">
                                                                    <div class="form-group">
                                                                        <label for="editAdminName">Administrator Name</label>
                                                                        <input type="text" class="form-control" id="editAdminName" placeholder="Enter Administrator name">
                                                                    </div>
