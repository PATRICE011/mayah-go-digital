...
@section('title', 'Mayah Store - Admin Return and Refund')

@include('admins.adminheader', ['activePage' => 'refund'])
@section('content')
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h3 class="mb-2">Return and Refunds</h3>
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="#" class="breadcrumb-link">Return and Refunds</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="filterModalLabel">Filter Return and Refunds</h5>
                                        ...
                                        <form id="filterForm">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="filterStatus">
                                                    ...
                                                    <option value="active">Declined</option>
                                                </select>
                                            </div>
                                        </form>
                                    </div>
